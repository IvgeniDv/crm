...
if(isset($_GET['service_id'])){
    ...
    $query_delete_service = "DELETE FROM services
                        WHERE `service_id` = '$service_id' ";


    $result = mysqli_query($con, $query_delete_service);
    ...
    $message_err = "Somthing went wrong with updating the database.<br>Service wasnt disabled.<br>Contact support.";
